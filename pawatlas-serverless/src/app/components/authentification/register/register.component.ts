...
// https://angular.dev/guide/forms/form-validation#adding-custom-validators-to-reactive-forms
...
export class RegisterComponent implements OnDestroy, OnInit {
  ...
  // ^ and $ are the start and end of the string, avoiding partial matches
  // (?=.*[0-9]) must contain at least one number
  // (?=.*[a-zA-Z]) must contain at least one letter
  // (?=.*[A-Z]) must contain at least one uppercase letter
  // [a-zA-Z0-9!@#$%^&*] can contain letters, numbers and special characters
